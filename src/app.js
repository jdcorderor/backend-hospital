...
// Módulo de Consultas Odontológicas.
...
Instanciación del servidor y configuraciones varias.
...
// Middlewares.
app.use(cors()); // Gestionar solicitudes de origen cruzado.
app.use(morgan("dev")); // Registro de solicitudes HTTP.
app.use(json()); 
app.use(stc("public")); // Servicio de activos estáticos de la app.

/*
    Declaración de las rutas para los endpoints.
*/
